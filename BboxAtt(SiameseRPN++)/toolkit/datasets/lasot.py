...
class LaSOTDataset(Dataset):
    ...
    def __init__(self, name, dataset_root, load_img=False):
        ...
        with open(os.path.join(dataset_root, name+'_test.json'), 'r') as f:
        ...
        for video in pbar:
            ...
            video_name = [x.split('-')[0] for x in meta_data[video]['img_names']]
            meta_data[video]['img_names'] = [os.path.join(video_name[0] , x) for x in meta_data[video]['img_names']]
