...
parser.add_argument('--tracker_path', '-p', default='new_results/std-0.05-1',type=str,
                    help='tracker result path')
parser.add_argument('--dataset', '-d', default='OTB', type=str,
                    help='dataset name')
...
def main():
    ...
    root = '/file01/dataset'
    root = os.path.join(root, 'dataset_'+args.dataset)
